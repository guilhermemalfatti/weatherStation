...
def mainUpload(stdscr):
	...
	try:
		...
		while(aux02 == 1):
			...
			params = {"data": str(year)+str(month)+str(day), "code" : md5.new('miniColetor').hexdigest(), "umidade" : dht.humidity(), "codEstacao" : "361", "temp" : dht.temp(), "time" : str(hour)+":"+str(minute)+":"+str(second)}
			query = urllib.urlencode(params)
			url = "http://mosaico.upf.br/~coletor/webStation/apps/receiveMiniColetor.php"
